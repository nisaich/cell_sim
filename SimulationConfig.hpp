...
inline constexpr float food_diffusion_coeff = 0.005f;  // Не больше 0.25 (математическое ограничение стабильности)
inline constexpr float biomass_diffusion_coeff = 0.25f; // Коэффициент диффузии биомассы
inline constexpr int steps_for_adding_food = 10;
inline constexpr int count_of_adding_food = 1000;
}
