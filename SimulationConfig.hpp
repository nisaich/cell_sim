...
inline constexpr float initial_food = 0.6f;
inline constexpr float default_initial_food = 3.0f;
...
inline constexpr float reproduction_chance = 0.02f; // Шанс деления 20% за тик
inline constexpr float child_biomass_ratio = 0.5f; // 50/50 распределение при делении
inline constexpr int steps_for_nonactivating = 1000; // 800 тиков голодания до спячки
inline constexpr int steps_to_live_forward = 2000; // 1600 тиков голодания до смерти
...
inline constexpr int dead_steps_to_disappearance = 10000000;
}
