...
inline constexpr float biomass_diffusion_coeff = 0.25f; // Коэффициент диффузии биомассы
...
inline constexpr float default_max_food_consumed = 5.0f; // Скорость поедания (деление за ~400 тиков)
...
inline constexpr int default_max_age = 10000000; // Старение за 10000 тиков
...
inline constexpr int steps_for_nonactivating = 50; // 800 тиков голодания до спячки
inline constexpr int steps_to_live_forward = 100; // 1600 тиков голодания до смерти
